...
test('version consistency check accepts the current cache-busted PWA markers', () => {
  ...
  assert.equal(result.appVersion, 'clefhanger-slice47-version-consistency-2026-09-01');
  assert.equal(result.sliceMarker, 'Slice 47: version consistency');
  assert.equal(result.cacheName, 'clefhanger-pwa-v41');
...
<html data-app-version="clefhanger-slice47-version-consistency-2026-09-01">
  <body>
    <p class="microcopy">Slice 47: version consistency</p>
    <script type="module" src="./src/app.js?v=old-version"></script>
    <script>navigator.serviceWorker.register('./sw.js?v=clefhanger-slice47-version-consistency-2026-09-01')</script>
  </body>
</html>`,
    'src/app.js': `import './core/game.js?v=clefhanger-slice47-version-consistency-2026-09-01';
const appVersion = 'clefhanger-slice47-version-consistency-2026-09-01';`,
    'sw.js': `const CACHE_NAME = 'clefhanger-pwa-v41';
...
<html data-app-version="clefhanger-slice47-version-consistency-2026-09-01">
  <body>
    <p class="microcopy">Slice 47: version consistency</p>
    <script type="module" src="./src/app.js?v=clefhanger-slice47-version-consistency-2026-09-01"></script>
    <script>navigator.serviceWorker.register('./sw.js?v=clefhanger-slice47-version-consistency-2026-09-01')</script>
  </body>
</html>`,
    'src/app.js': `import './core/game.js?v=clefhanger-slice47-version-consistency-2026-09-01';
