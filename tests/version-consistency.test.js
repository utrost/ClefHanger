...
test('version consistency check accepts the current cache-busted PWA markers', () => {
  ...
  assert.equal(result.appVersion, 'clefhanger-slice58-mobile-mic-polish-2026-09-10');
  assert.equal(result.sliceMarker, 'Slice 58: mobile mic polish');
  assert.equal(result.cacheName, 'clefhanger-pwa-v52');
...
<html data-app-version="clefhanger-slice58-mobile-mic-polish-2026-09-10">
  <body>
    <p class="microcopy">Slice 58: mobile mic polish</p>
    <script type="module" src="./src/app.js?v=old-version"></script>
    <script>navigator.serviceWorker.register('./sw.js?v=clefhanger-slice58-mobile-mic-polish-2026-09-10')</script>
  </body>
</html>`,
    'src/app.js': `import './core/game.js?v=clefhanger-slice58-mobile-mic-polish-2026-09-10';
const appVersion = 'clefhanger-slice58-mobile-mic-polish-2026-09-10';`,
    'sw.js': `const CACHE_NAME = 'clefhanger-pwa-v52';
...
<html data-app-version="clefhanger-slice58-mobile-mic-polish-2026-09-10">
  <body>
    <p class="microcopy">Slice 58: mobile mic polish</p>
    <script type="module" src="./src/app.js?v=clefhanger-slice58-mobile-mic-polish-2026-09-10"></script>
    <script>navigator.serviceWorker.register('./sw.js?v=clefhanger-slice58-mobile-mic-polish-2026-09-10')</script>
  </body>
</html>`,
    'src/app.js': `import './core/game.js?v=clefhanger-slice58-mobile-mic-polish-2026-09-10';
