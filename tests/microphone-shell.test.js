...
test('settings expose microphone input and live calibration controls', () => {
  ...
  assert.match(app, /const appVersion = 'clefhanger-slice45-scoring-helpers-2026-09-01'/);
  assert.match(app, /\.\/core\/mic-diagnostics\.js\?v=clefhanger-slice45-scoring-helpers-2026-09-01/);
