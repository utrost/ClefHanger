import {
  ...
  getMode,
  getSpeed,
} from './core/content.js?v=clefhanger-slice56-mic-first-lessons-2026-09-10';
import {
  STAFF_LAYOUT,
  createInitialState,
  startRound,
  ...
  getRemainingSeconds,
  getRoundSummary,
} from './core/game.js?v=clefhanger-slice56-mic-first-lessons-2026-09-10';
import { getPromptFrequencies } from './core/music-theory.js?v=clefhanger-slice56-mic-first-lessons-2026-09-10';
import { getCalibrationTone, playPianoVoice } from './core/audio.js?v=clefhanger-slice56-mic-first-lessons-2026-09-10';
import {
...
} from './core/pitch.js?v=clefhanger-slice56-mic-first-lessons-2026-09-10';
import { buildMicDiagnosticReport, buildMicDiagnosticTextFile, formatDiagnosticLevelPercent } from './core/mic-diagnostics.js?v=clefhanger-slice56-mic-first-lessons-2026-09-10';
import { BEGINNER_LESSONS, applyLearningFeedback, buildAccidentalLearningHint, buildBeginnerMicMessage, buildIntervalLearningHint, buildLearningRecommendation, buildTutorialSteps, getBeginnerLesson, getLessonIntroCard, getScaffoldedAnswerOptions } from './core/learning.js?v=clefhanger-slice56-mic-first-lessons-2026-09-10';
import { renderStaffSvg } from './ui/staff-renderer.js?v=clefhanger-slice56-mic-first-lessons-2026-09-10';
import { startMicrophoneSession, formatMicrophoneError } from './platform/microphone-session.js?v=clefhanger-slice56-mic-first-lessons-2026-09-10';
import { runMicrophoneRecordingDiagnostic } from './platform/mic-recording-diagnostic.js?v=clefhanger-slice56-mic-first-lessons-2026-09-10';
import { createStorageAdapter } from './platform/storage.js?v=clefhanger-slice56-mic-first-lessons-2026-09-10';
