...
- Visible marker says `Slice 57: mic report fixtures`.
...
2. Confirm the HTML contains `clefhanger-slice57-mic-report-fixtures`.
3. Confirm these assets return HTTP 200:
   ...
   - icons
4. Confirm `sw.js` contains `clefhanger-pwa-v51`.
