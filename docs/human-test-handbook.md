...
- Visible marker says `Slice 61: mic-first lesson cards`.
...
2. Confirm the HTML contains `clefhanger-slice61-mic-first-lesson-cards`.
3. Confirm these assets return HTTP 200:
   ...
   - icons
4. Confirm `sw.js` contains `clefhanger-pwa-v55`.
