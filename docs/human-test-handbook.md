...
- Visible marker says `Slice 62: microphone lifecycle`.
...
2. Confirm the HTML contains `clefhanger-slice62-microphone-lifecycle`.
3. Confirm these assets return HTTP 200:
   ...
   - icons
4. Confirm `sw.js` contains `clefhanger-pwa-v56`.
