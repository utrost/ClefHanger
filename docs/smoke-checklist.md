...
- Tap **Play A**, sing A back, and verify both the settings calibration readout and the main `You played A4 · 440 Hz · in tune` style readout update with detected note, Hz, and cents. If no microphone is available, verify the blocked/unavailable message is visible and the console stays clean.
...
- Verify the HTML contains `clefhanger-slice12-heard-note-display`.
