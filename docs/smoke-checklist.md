...
- The title, timer, score, mode selector, speed selector, staff, feedback, start button, typed-answer row, and answer buttons are visible without horizontal scrolling.
- Switch through Treble, Bass, Sharps #, Flats ♭, and Chords.
- Switch through Slow, Normal, and Fast.
- Treble mode shows a treble clef centered on the staff rather than floating above it.
...
- Verify the HTML contains `clefhanger-slice3`.
