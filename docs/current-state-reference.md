...
This document describes what exists in code today in `clefhanger-slice56-mic-first-lessons-2026-09-10`. It is an implementation reference, not a future roadmap. For the product-level path a normal player is supposed to follow, see [User Journey](./user-journey.md). For repeatable manual pass/fail test cases, see [Human Test Handbook](./human-test-handbook.md).
...
- Current app marker: `clefhanger-slice56-mic-first-lessons-2026-09-10`.
- Current visible slice marker: `Slice 56: mic-first lessons`.
- Current service-worker cache: `clefhanger-pwa-v50`.
- Core/UI modules:
