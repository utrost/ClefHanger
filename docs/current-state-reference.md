...
This document describes what exists in code today in `clefhanger-slice62-microphone-lifecycle-2026-09-16`. It is an implementation reference, not a future roadmap. For the product-level path a normal player is supposed to follow, see [User Journey](./user-journey.md). For repeatable manual pass/fail test cases, see [Human Test Handbook](./human-test-handbook.md).
...
- Current app marker: `clefhanger-slice62-microphone-lifecycle-2026-09-16`.
- Current visible slice marker: `Slice 62: microphone lifecycle`.
- Current service-worker cache: `clefhanger-pwa-v56`.
- Core/UI modules:
