...
This guide is for someone opening the current ClefHanger build and trying to use it, test it, or send useful feedback. For exact constants and implementation details, see [Current State Reference](./current-state-reference.md).
