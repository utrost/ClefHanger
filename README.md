...
- Mic startup shows immediate visible progress in both the main Mic panel and the settings calibration line, uses a simpler Chrome-friendly mic request, and times out with a site-settings hint if the browser never resolves the permission request.
