...
- Mic startup shows immediate visible progress in both the main Mic panel and the settings calibration line, uses a simpler Chrome-friendly mic request, and turns permission denials/timeouts into explicit Chrome site-settings instructions.
